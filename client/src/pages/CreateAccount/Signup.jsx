...
const CreateAccount = () => {
    const selectedAccount = useSelector(state => state.accountSelect)
    const [input, setinput] = useState({})
    const [accountType, setAccountType] = useState(selectedAccount || 'voter')
                            ...
                            <span className='phone'>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setinput({ ...input, [e.target.name]: e.target.value })}
                                    name='address'
                                    placeholder='Address (only Country)'
                                />

                            </span>
                        </span>
                        <br />
                        <textarea name="description" className='user_desc' id="" cols="10" placeholder='Describe about ideator(experience, age, qualification etc. (less than 1000 words).' rows="10" value={input.description || ''}
                            onChange={(e) =>
